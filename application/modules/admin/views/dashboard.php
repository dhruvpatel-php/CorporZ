    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span><a href="#" class="small-box-footer">View All <i class="fa fa-arrow-circle-right"></i></a></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="col-md-12 col-sm-12">
                    <h1 style="color: #020203ff;font-weight: bold;text-transform:uppercase;display:inline-block;">
