    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <p>© Copyright <?php echo date('Y'); ?> <span id="year"></span> By CorporZ. All Rights Reserved<br />Maintained By <a href="https://github.com/dhruvpatel-php" target="_blank" rel="noopener noreferrer"><span class="color">Dhruv Patel</span></a></p>
            </div>
        </div>
    </div>
</div>
